...
import { NzMessageService, NzMessageDataOptions, NzModalService } from 'ng-zorro-antd';
...
export class OsharpService {
  ...
  goto(url: string,extras?:NavigationExtras) {
    this.m.closeAll();
    setTimeout(() => this.router.navigateByUrl(url,extras),500);
  }

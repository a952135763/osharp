...
namespace KaPai.Pay.Web.Controllers
{
    ...
    public class TestController : ApiController
    {
        ...
        public TestController(UserManager<User> userManager, IIdentityContract identityContract, IMerchantContract merchantContract)
        {
            _userManager = userManager;
            _identityContract = identityContract;
            this._merchantContract = merchantContract;
        }

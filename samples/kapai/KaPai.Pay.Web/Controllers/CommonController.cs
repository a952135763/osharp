...
using KaPai.Pay.Common;
using KaPai.Pay.Security;
using KaPai.Pay.Systems;
...
namespace KaPai.Pay.Web.Controllers
{
    ...
    public class CommonController : ApiController
    {
        ...
        public CommonController(
            ...
            ISystemsContract systemsContract)
        {
        ...
        [ModuleInfo]
        [Description("获取区域列表")]
        public async Task<AjaxResult> GetRegion(int level = 1)
        {
            var arr = await _systemsContract.GetRegion(level);
           return new OperationResult<GlobalRegionDto[]>(OperationResultType.Success, "OK", arr).ToAjaxResult();
        }

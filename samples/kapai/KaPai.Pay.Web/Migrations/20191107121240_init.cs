        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Maxmum = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleAssort", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticleAssort_Channels_ChannelId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    ChannelJson = table.Column<JsonDocument>(nullable: true),
                    CreatedTime = table.Column<DateTime>(nullable: false),
                    LastUpdaterId = table.Column<int>(nullable: true),
                    LastUpdatedTime = table.Column<DateTime>(nullable: true),
                    ChannelId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChannelType_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Extra = table.Column<JsonDocument>(nullable: true),
                    ...
                    ArticleAssortId = table.Column<Guid>(nullable: false),
                    xmin = table.Column<uint>(type: "xid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArticleEntities_ArticleAssort_ArticleAssortId",
                        column: x => x.ArticleAssortId,
                        principalTable: "ArticleAssort",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    Orderid = table.Column<string>(maxLength: 100, nullable: false),
                    CreatedAmount = table.Column<long>(nullable: false),
                    PayAmount = table.Column<long>(nullable: false),
                    ...
                    AsynUrl = table.Column<string>(maxLength: 200, nullable: false),
                    JobId = table.Column<string>(maxLength: 50, nullable: true),
                    Status = table.Column<int>(nullable: false),
                    CreatedTime = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    ChannelId = table.Column<Guid>(nullable: false),
                    ArticleAssortId = table.Column<Guid>(nullable: true),
                    xmin = table.Column<uint>(type: "xid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ArticleEntities_ArticleAssortId",
                        column: x => x.ArticleAssortId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Percentage_Channels_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Accumulative = table.Column<long>(nullable: false),
                    CreatedTime = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    xmin = table.Column<uint>(type: "xid", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    PayID = table.Column<string>(maxLength: 50, nullable: true),
                    PayType = table.Column<string>(maxLength: 50, nullable: true),
                    AfterAmounts = table.Column<long>(nullable: false),
                    BeforeAmounts = table.Column<long>(nullable: false),
                    Amounts = table.Column<long>(nullable: false),
                    Remarks = table.Column<string>(maxLength: 200, nullable: true),
                    CreatedTime = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    xmin = table.Column<uint>(type: "xid", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmountsLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AmountsLog_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankType = table.Column<string>(maxLength: 100, nullable: true),
                    CreatorId = table.Column<int>(nullable: true),
                    CreatedTime = table.Column<DateTime>(nullable: false),
                    LastUpdaterId = table.Column<int>(nullable: true),
                    LastUpdatedTime = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Name = table.Column<string>(maxLength: 30, nullable: true),
                    BankType = table.Column<string>(maxLength: 30, nullable: true),
                    ...
                    LastUpdatedTime = table.Column<DateTime>(nullable: true),
                    UserId = table.Column<int>(nullable: false),
                    ProUserId = table.Column<int>(nullable: true),
                    xmin = table.Column<uint>(type: "xid", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashLog_User_ProUserId",
                        column: x => x.ProUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_CashLog_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedTime = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    PUserId = table.Column<int>(nullable: true),
                    xmin = table.Column<uint>(type: "xid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MerchantExtra", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MerchantExtra_User_PUserId",
                        column: x => x.PUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_MerchantExtra_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(nullable: false),
                    PayId = table.Column<string>(maxLength: 50, nullable: false),
                    PayType = table.Column<string>(maxLength: 50, nullable: true),
                    BeforePoint = table.Column<long>(nullable: false),
                    AfterPoint = table.Column<long>(nullable: false),
                    Point = table.Column<long>(nullable: false),
                    Remarks = table.Column<string>(maxLength: 200, nullable: true),
                    CreatedTime = table.Column<DateTime>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvideExtra", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProvideExtra_User_PUserId",
                        column: x => x.PUserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProvideExtra_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Amounts_UserId",
                table: "Amounts",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AmountsLog_UserId",
                table: "AmountsLog",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleAssort_ChannelId",
                table: "ArticleAssort",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleEntities_ArticleAssortId",
                table: "ArticleEntities",
                column: "ArticleAssortId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankList_UserId",
                table: "BankList",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CashLog_ProUserId",
                table: "CashLog",
                column: "ProUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CashLog_UserId",
                table: "CashLog",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelType_ChannelId",
                table: "ChannelType",
                column: "ChannelId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MerchantExtra_PUserId",
                table: "MerchantExtra",
                column: "PUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MerchantExtra_UserId",
                table: "MerchantExtra",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ArticleAssortId",
                table: "Orders",
                column: "ArticleAssortId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Percentage_ChannelId",
                table: "Percentage",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_Percentage_UserId",
                table: "Percentage",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProvideExtra_PUserId",
                table: "ProvideExtra",
                column: "PUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProvideExtra_UserId",
                table: "ProvideExtra",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ArticleEntities_User_UserId",
                table: "ArticleEntities",
                column: "UserId",
                principalTable: "User",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Percentage_User_UserId",
                table: "Percentage",
                column: "UserId",
                principalTable: "User",
                principalColumn: "Id",

...
//      1.横向扩展：如需给当前控制器添加API，请在控制器类型 MerchantExtraController.cs 进行添加
//      2.纵向扩展：如需要重写当前控制器的API实现，请在控制器类型 MerchantExtraController.cs 进行继承重写
// </auto-generated>
//
//  <copyright file="MerchantExtraBase.generated.cs">
...
namespace KaPai.Pay.Web.Areas.Admin.Controllers
{
    ...
    [Description("管理-商户参数信息")]
    public abstract class MerchantExtraControllerBase : AdminApiController
    {
        /// <summary>
        /// 初始化一个<see cref="MerchantExtraController"/>类型的新实例
        /// </summary>
        protected MerchantExtraControllerBase(IMerchantContract merchantContract,
        ...
        /// <returns>商户参数列表分页信息</returns>
        [HttpPost]
        [ModuleInfo]
        [Description("读取")]
        public virtual PageData<MerchantExtraOutputDto> Read(PageRequest request)
        {
        ...
        /// 更新商户参数信息
        /// </summary>
        /// <param name="dtos">商户参数信息输入DTO</param>
        ...
        [Description("更新")]
        public virtual async Task<AjaxResult> Update(MerchantExtraInputDto[] dtos)
        {
